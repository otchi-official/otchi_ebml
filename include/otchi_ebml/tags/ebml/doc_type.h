...
#ifndef INCLUDE_OTCHI_EBML_DOC_TYPE_H
#define INCLUDE_OTCHI_EBML_DOC_TYPE_H
...
namespace otchi::ebml {
	...
	class DocType final : public EbmlElement<EbmlType::String> {
	public:
		using EbmlElement<EbmlType::String>::EbmlElement;

		static constexpr ebml_id doc_type_id = 0x4282;
	...
	class DocTypeFactory final : public IEbmlElementFactory {
	public:
...
#endif //INCLUDE_OTCHI_EBML_DOC_TYPE_H

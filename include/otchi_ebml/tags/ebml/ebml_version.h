...
namespace otchi::ebml {
	...
	class EbmlVersion final : public EbmlElement<EbmlType::UnsignedInteger> {
	public:
		using EbmlElement<EbmlType::UnsignedInteger>::EbmlElement;

		static constexpr ebml_id ebml_version_id = 0x4286;
	...
	class EbmlVersionFactory final : public IEbmlElementFactory {
	public:
